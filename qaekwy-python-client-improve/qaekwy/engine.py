...
class AbstractAction(ABC):
    ...
    def execute(self) -> requests.Response:
        ...
        # add proxy support
        proxies = {
            "http": "http://172.19.120.29:3128/",
            # "https": "https://172.19.120.29:3128/",
            "https": "http://proxy.sfit.shfe.com.cn:3128/",  # 可行
            # "http": "socket5://@proxy.sfit.shfe.com.cn:3128/",
            # "http": "http://proxy.sfit.shfe.com.cn:3128/",
        }

        if self.body is None:
            res = requests.get(request_line, proxies=proxies, timeout=30)
        else:
            res = requests.post(request_line, data=self.body, proxies=proxies, timeout=5)
